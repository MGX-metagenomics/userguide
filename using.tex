...
For each project, MGX provides dedicated storage in order to allow users to
...
FIXME: Screenshot MGX file storage
...
\section{Importing reference genomes}
...
``Upload EMBL/GenBank/FASTA reference'' to provide an own sequence.\\
